...
public class RandomDtoGenerator {
    ...
    private static final int leftLimitSTR = 97; // 'a'
    private static final int rightLimitSTR = 122; // 'z'
    private static final int targetStringLength = 10;
    private static final int leftLimitCHAR = 32; // первый печатный символ ASCII
    ...
    private char generateRandomChar() {
        // Генерируем случайное число, соответствующее ASCII коду символа
